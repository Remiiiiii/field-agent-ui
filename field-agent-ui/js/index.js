...
function confirmDelete(agentId) {
  fetchAgent(agentId).then((agent) => {
    document.querySelector(".delete ul").innerHTML = `
                ...
                <li>Middle Name: ${
                  agent.middleName ? agent.middleName : "N/A"
                }</li>
...
document.getElementById("linkAgents").addEventListener("click", (evt) => {
  evt.preventDefault();
  showList();
});

document.getElementById("linkAgencies").addEventListener("click", (evt) => {
  evt.preventDefault();
});
